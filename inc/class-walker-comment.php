...
if (!class_exists('Cubarestaurant_Walker_Comment')) {
    /**
     * CUSTOM COMMENT WALKER
     * A custom walker for comments, based on the walker in Twenty Nineteen and Twenty Twenty.
     */
    class Cubarestaurant_Walker_Comment extends Walker_Comment
    {
                    ...
                    <div class="comment-metadata">
                        ...
                        <div class="comment-meta-wrap">
                            ...
                            <div class="comment-author vcard">
									<span class="fn">
									<?php
                                    esc_html_e('Posted by: ', 'cubarestaurant');
                                    if (empty($comment_author_url)) {
                ...
                <div class="comment-content">
                    ...
                    if ('0' === $comment->comment_approved) {
                        ...
                        <p class="comment-awaiting-moderation">
                            <b><?php esc_html_e('Your comment has been successfully submitted and is awaiting moderation.', 'cubarestaurant'); ?></b>
                        </p>
                        <?php
                    }
                    ?>
