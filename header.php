...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e('Skip to content', 'cubarestaurant'); ?></a>
        ...
        <div class="mainNavbar">
            ...
            <nav id="site-navigation" class="main-navigation">
                <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
                    <span class="screen-reader-text"><?php esc_html_e('Primary Menu', 'cubarestaurant'); ?></span><i
                            class="fa fa-plus"></i>
                </button>
                <?php
                wp_nav_menu(
